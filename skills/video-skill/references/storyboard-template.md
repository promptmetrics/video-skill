...
Keep this distinction in mind: scene boundaries are planned in global frames, but every animation spec inside a scene is written against that scene's local frame counter (which resets to 0 at scene start). This skill produces a script + storyboard + visual design spec only — no audio and no rendered video.
...
## Visual Style
- **Reference Style**: [Kurzgesagt-style flat geometric / Custom]
...
- **Pacing**: [Brisk / Measured / Slow build]
...
### Narration
> "To understand how airplanes fly, we need to know about four important forces: lift, gravity, thrust, and drag."
...
|----------------|-------|---------------|
| "Lift" | 150 | Lift arrow appears |
| "Gravity" | 240 | Gravity arrow appears |
| "And that's how..." | 500 | All elements highlight |
...
- **Subtitle Breaks**:
  ```
  Line 1: To understand how airplanes fly
  Line 2: we need to know about four important forces
  ```
...
| Time Code | Frame | Layer | Element | Action | Sync Cue |
|-----------|-------|-------|---------|--------|----------|
| 0:00.00 | 0 | BG | Background | Fade in (20f) | Scene open |
| 0:00.67 | 20 | MG | Airplane | Spring in (30f) | - |
| 0:01.67 | 50 | MG | LiftArrow | Spring in (25f) | "Lift" spoken |
| 0:02.50 | 75 | FG | Label "Lift" | Fade in (15f) | - |
| 0:02.50 | 75 | VO | Narration | Start | "First, let's look at lift..." |

### Legend
- **Layer**: BG (Background), MG (Midground), FG (Foreground), UI, VO (Voiceover / narration script beat)
...
```markdown
## Timing Sheet: How Do Airplanes Fly?
...
| Time Code | Frame | Layer | Element | Action | Sync Cue |
|-----------|-------|-------|---------|--------|----------|
| 0:00.00 | 0 | BG | SkyGradient | Instant show | Scene open |
| 0:00.00 | 0 | BG | Clouds | Drift right (loop) | - |
| 0:00.33 | 10 | MG | Airplane | Enter from left (50f) | - |
| 0:02.00 | 60 | MG | Airplane | Hover bob (loop) | - |
| 0:02.00 | 60 | VO | Narration | Start | "Have you ever wondered..." |
| 0:04.00 | 120 | FG | QuestionMark | Bounce in (30f) | - |
| 0:06.00 | 180 | ALL | - | Hold | - |
| 0:07.33 | 220 | ALL | Everything | Fade out (20f) | Scene exit |
...
| 0:09.67 | 290 | VO | Narration | Start | "To understand how airplanes fly..." |
| 0:10.50 | 315 | MG | LiftArrow | Spring up (25f) | "lift" |
| 0:11.33 | 340 | UI | Label "Lift" | Fade in (15f) | - |
| 0:12.17 | 365 | MG | GravityArrow | Spring down (25f) | "gravity" |
| ... | ... | ... | ... | ... | ... |
```
...
## Visual Style
- **Reference Style**: Kurzgesagt-style flat geometric
- **Color Palette**: 
...
- **Pacing**: Measured, with pauses for diagrams to land
...
> how a giant plane **weighing hundreds of tons** [PAUSE]
> can fly through the sky like a *little bird*?"

**Word Count**: ~22 words
**Estimated Duration**: ~7 seconds at 3 words/sec
...
| Narration Text | Frame | Visual Action |
|----------------|-------|---------------|
| "Have you ever wondered" | 60 | Airplane reaches center |
| "weighing hundreds of tons" | 90 | Airplane emphasized (subtle scale pulse) |
| "fly through the sky" | 120 | Question mark bounces in |
...
- **Typography**:
  - Subtitles: Inter Medium 36px, white with shadow
...
- **Subtitle Breaks**:
  ```
  Line 1: Have you ever wondered
  Line 2: how a giant plane weighing hundreds of tons
  Line 3: can fly through the sky
  Line 4: like a little bird?
  ```
...
- **Labels**: "Low pressure", "High pressure", "Lift" appear at appropriate times
- **Progress**: None

### Narration Script
> "First, let's look at **lift**. [...]
> Lift is the *most important* force that gets a plane into the air.
> It comes from the plane's wings, also called the **airfoil**. [PAUSE]
>
> Look at the shape of the wing:
> the top is **curved**, and the bottom is fairly **flat**. [...]
>
> As the plane moves forward,
> air flows over the top and bottom of the wing *at the same time*. [PAUSE]
>
> Because the top is curved, the air has to travel a **longer** path,
> so it moves **faster**. [...]
>
> Here's a remarkable rule:
> the faster the air moves, the **lower** its pressure. [PAUSE]
>
> So the pressure above the wing... is lower than below.
> The air underneath pushes the wing **up**!
>
> And that's the secret of **lift**!"

**Word Count**: ~110 words
**Estimated Duration**: ~42 seconds at 2.6 words/sec
...
| Narration Text | Frame | Visual Action |
|----------------|-------|---------------|
| "lift" (first) | 860 | Wing begins appearing |
| "airfoil" | 940 | Wing fully visible |
| "the top is curved" | 1000 | Top curve highlights |
| "the bottom is fairly flat" | 1050 | Bottom line highlights |
| "air flows over the top and bottom" | 1140 | Air flow lines start |
| "moves faster" | 1440 | Top flow speeds up |
| "lower its pressure" | 1600 | Low pressure zone appears |
| "pushes the wing up" | 1900 | Lift arrow springs up |
...
- **SVG Components**:
  ...
  - `LiftArrow`: Upward arrow with "Lift" label
- **Icons**: None
- **Colors Used**:
